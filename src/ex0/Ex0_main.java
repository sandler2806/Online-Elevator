...
public class Ex0_main {
    public static Long ID0=318995156L, ID1 = 319097036L, ID2 = null;
    public static void main(String[] ar) {
        ...
        ElevatorAlgo ex0_alg = new algo1(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
